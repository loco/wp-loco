...
<p>
    <a href="<?php echo esc_url(apply_filters('loco_external','https://localise.biz/help/wordpress/translate-plugin/manual/bundle-config'))?>" target="_blank">Full documentation</a>
</p>