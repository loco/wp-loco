...
public function pushMeta(  $source, array $meta,  $domain = '' ) { trigger_error('Just call pushEntry', E_USER_DEPRECATED ); return $this->pushEntry( ['source'=>$source] + $meta, $domain ); } 
