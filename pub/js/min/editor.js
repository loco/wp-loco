...
var U, P, q = (P = parseInt(k(c).css("min-height") || 0), function() {
var n = function(n, t) {
for (var o = n.offsetTop || 0; (n = n.offsetParent) && n !== t; ) o += n.offsetTop || 0;
return o;
}(c, document.body), t = S.innerHeight, o = Math.max(P, t - n - 20);
U !== o && (c.style.height = String(o) + "px", U = o);
});
q(), k(S).resize(q), c.innerHTML = "", D = C.po.ed.init(c).localise(t), C.po.kbd.init(D).add("save", j ? function() {
D.dirty && G();
...
return n.preventDefault(), o(), k(t).addClass("loco-loading"), G(e), !1;
}), !0;
},
sync: j && function(t) {
var n = i.project;
...
k(c).trigger("poUnsaved", []), V(), u && S.console && function(n, t) {
...
p || I ? C.notices.error("Logic error. APIs not available in current mode") : null == r || 0 === r.length || 10 < Math.round((e() - L) / 1e3) ? (a && a.remove(), 
...
L = e(), 0 === (r = n && n.apis || []).length ? a = _("loco-apis-empty", n.html) : h = _("loco-apis-batch", n.html), 
o.remove(), t(r);
})) : (L = e(), t(r));
}
function _(n, t) {
...
function a(n, t, o, e) {
var a = e.getId(), i = w[a], r = String(i + 1), l = e.getUrl(), s = N("Use this translation"), c = String(e), u = b && b[a], d = k('<button class="button button-primary"></button>').attr("tabindex", String(1 + f + i)).on("click", function(e, a) {
return function(n) {
...
var v = (z = z || _("loco-apis-hint", "<div></div>")).html("").append(k('<div class="loco-api"><p>Source text:</p></div>').append(k('<blockquote lang="en"></blockquote>').text(o))).dialog("option", "title", N("Loading suggestions") + "...").off("dialogclose").on("dialogclose", g).dialog("open"), r = n.translation(t);
r && k('<div class="loco-api"><p>Current translation:</p></div>').append(k("<blockquote " + p + "></blockquote>").text(r)).append(k('<button class="button"></button>').attr("tabindex", String(++f)).text(N("Keep this translation")).on("click", function(n) {
n.preventDefault(), g();
})).appendTo(v);
